...
const FEATURES: ReadonlyArray<Feature> = [
  {title: "Быстрый старт", text: "Короткая первичная диагностика и рекомендации уже в день обращения.", Icon: Calendar},
  {title: "Личный план", text: "Пошаговые цели и практики под ваш ритм жизни и запрос.", Icon: Target},
  {
  ...
  {title: "Когда удобно вам", text: "Гибкий график и онлайн-формат. Напоминания и трекинг прогресса.", Icon: Clock},
  {
